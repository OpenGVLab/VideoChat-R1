...
# QUESTION_TEMPLATE_GQA = """Answer the question: "[QUESTION]" according to the content of the video. Select the answer from :[OPTION]. Provide your answer within the <answer> </answer> tags, output the corresponding letter of the option. At the same time, in the <glue> </glue> tags, present the precise time period in seconds of the video clips on which you base your answer to this question in the format of [(s1, e1), (s2, e2), ...]. For example: <answer>A</answer><glue>[(5.2, 10.4)]</glue>.
# """
...
QUESTION_TEMPLATE_GLUE = """Answer the question: "[QUESTION]" according to the content of the video. Select the answer from :[OPTION].

provide your answer within the <answer> </answer> tags, output the corresponding letter of the option. At the same time, in the <glue> </glue> tags, present the precise time period in seconds of the video clips on which you base your answer to this question in the format of [(s1, e1), (s2, e2), ...]. For example: <answer>A</answer><glue>[(5.2, 10.4)]</glue>.
"""

QUESTION_TEMPLATE_THINK = """Answer the question: "[QUESTION]" according to the content of the video. Select the answer from :[OPTION].

Output your thought process within the <think> </think> tags.

Then, provide your answer within the <answer> </answer> tags, output the corresponding letter of the option.For example: <think>A</think><answer>A</answer>.
"""

class Qwen2VLGRPOTrainer_GQA_Tasks(Trainer):
    """
    ...
    def make_conversation_video(self, example):
        if example['data_type'] == 'glue':
            example_prompt = QUESTION_TEMPLATE_GLUE.replace("[QUESTION]", example["problem"]["question"])
            example_prompt = example_prompt.replace("[OPTION]", str(example["problem"]["options"]))
        # print(example_prompt)
        elif example['data_type'] == 'think':
            example_prompt = QUESTION_TEMPLATE_THINK.replace("[QUESTION]", example["problem"]["question"])
            example_prompt = example_prompt.replace("[OPTION]", str(example["problem"]["options"]))
