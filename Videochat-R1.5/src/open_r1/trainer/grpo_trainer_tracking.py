...
# Then, provide your answer within the <answer> </answer> tags as a list of eight sublists, where each sublist contains the normalized coordinates [x0, y0, x1, y1]. For example: <answer>[[0.1, 0.5, 0.3, 0.55], [0.72, 0.25, 0.84, 0.43], ...]</answer>.
# """
...
# QUESTION_TEMPLATE = 'Give a caption of the video.'
...
class Qwen2VLGRPOTrainer_Video_Track(Trainer):
    """
    ...
    def make_conversation_video(self, example):
        example_prompt = QUESTION_TEMPLATE.replace("[OBJECT]", example["problem"]["object"])
