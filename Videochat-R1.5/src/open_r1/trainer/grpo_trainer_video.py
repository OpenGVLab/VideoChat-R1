...
class Qwen2VLGRPOTrainer_Video(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        # /mnt/petrelfs/share/videointern/tools/rclone-v1.68.1-linux-amd64/rclone copy aliyun:pjlab-lingjun-internvideo/yanziang/models/Qwen2-VL-7B-Instruct huoshanyun:yanziang/models/Qwen2-VL-7B-Instruct 
